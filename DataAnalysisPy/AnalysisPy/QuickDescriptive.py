...
def categorical(df,
	...
	if verbose:
		...
		with summary_proportion:
			...
			slide_perc_rows = slide_perc_rows.style.background_gradient(cmap=cm)
		...
		with summary_pearson:
			...
			pearson_resid_df = pearson_resid_df.style.background_gradient(cmap=cm)
...
dic_scatterg2 = False, dic_cat = False):
	...
	tab.set_title(4, 'High/Low dimensional group')
	tab.set_title(5, 'Scatter plot')
	tab.set_title(6, 'Scatter plot, group 1')
	tab.set_title(7, 'Scatter plot, group 2')
	tab.set_title(8, 'Categorical analysis')
	tab.set_title(9, 'Fixed effect')
